...
routerU = routers.DefaultRouter()  # Define the router with our view
routerU.register(r'uploads', UploadViewSet)

routerR = routers.DefaultRouter()  # Define the router with our view
routerR.register(r'reviews', ReviewViewSet)
...
urlpatterns = [
  ...
  url(r'', include(routerU.urls)),  # Add the view to the patterns
  url(r'', include(routerR.urls)), path('auth/', obtain_jwt_token),
