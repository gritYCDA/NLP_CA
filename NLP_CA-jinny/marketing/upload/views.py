...
# serializers
from .models import UploadFile # Import our UploadFile model
...
class UploadViewSet(viewsets.ModelViewSet):  # Create a class based view
  authentication_classes = (BasicAuthentication,)
  permission_classes = (IsAuthenticated,)
  queryset = UploadFile.objects.all()  # Select all upload
  serializer_class = UploadSerializer  # Serialize data
